  ...
  useEffect(() => {
    const getPrestador = async () => {
      const res = await axios.get(
        `http://ec2-54-164-45-9.compute-1.amazonaws.com/api/prestadores/${id}`
      );
    ...
    const getFuncionarios = async () => {
      ...
      const response = await axios.get(
        `http://ec2-54-164-45-9.compute-1.amazonaws.com/api/prestadores/${id}/colaboradores`
      );
    ...
    const getFavourites = async () => {
      const res = await axios.get(
        `http://ec2-54-164-45-9.compute-1.amazonaws.com/api/users/${currentUser.uid}/favoritos`
      );
    ...
    const getServicos = async () => {
      const res = await axios.get(
        `http://ec2-54-164-45-9.compute-1.amazonaws.com/api/prestadores/${id}/servicos`
      );
